...
void Game::HandleInput() {
    ...
    if(IsGamepadAvailable(0)) {
        ...
        bool aPressed = IsGamepadButtonPressed(0, GAMEPAD_BUTTON_RIGHT_FACE_DOWN);
        ...
        bool yPressed = IsGamepadButtonPressed(0, GAMEPAD_BUTTON_RIGHT_FACE_UP);

        // Exit Combo
        if(startPressed && aPressed && bPressed && xPressed && yPressed) {
            running = false;
            return;
        }
